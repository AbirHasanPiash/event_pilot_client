...
export default function ProfilePage() {
  ...
  // --- SWR for fetching profile ---
  const { data: profile, isLoading } = useSWR<Profile | null>(
    "/api/profile/me/",
    (url) => apiFetch<Profile>(url),
  ...
  const onSubmit = async (data: Profile) => {
    try {
      ...
      mutate("/api/profile/me/", updated, false); // optimistic update
      setEditMode(false);
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      ...
      mutate("/api/profile/me/", updated, false);
  ...
  const handleImageDelete = async () => {
    ...
    try {
      ...
      mutate("/api/profile/me/", oldProfile, false); // rollback
